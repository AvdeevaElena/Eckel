...
public class AllocateDirectTest {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        System.out.println("Time to allocate 1024 bytes = "
                + allocationTime(1024) + " nanoseconds");
        System.out.println("Time to allocateDirect 1024 bytes = "
                + directAllocationTime(1024) + " nanoseconds");
        System.out.println("Time to allocate 48 bytes = "
                + allocationTime(48) + " nanoseconds");
        System.out.println("Time to allocateDirect 48 bytes = "
                + directAllocationTime(48) + " nanoseconds");
        System.out.println("Time to allocate 1 byte = "
                + allocationTime(1) + " nanoseconds");
        System.out.println("Time to allocateDirect 1 byte = "
